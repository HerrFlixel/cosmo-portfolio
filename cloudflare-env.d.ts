/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: fabe6b8ae4fa4a6f13db85f98409331f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_USERNAME" | "NEXTJS_ENV" | "ADMIN_PASSWORD_HASH" | "SESSION_SECRET" | "GALLERY_SECRET" | "RESEND_API_KEY" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "CONTACT_EMAIL">> {}
}
